...
在生产环境中使用 LLM 意味着要同时管理多家服务商，它们各自有着不同的延迟特征、速率限制和稳定性表现。公开的基准测试并不能反映**你的**网络环境、**你的**提示词、或**你的**流量模式。LLM Benchmark 是一个自托管工具，让你可以：
...
<p align="center">
  <img src="docs/demo.gif" alt="LLM Benchmark 演示" width="960" />
</p>
