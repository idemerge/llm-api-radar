      ...
      case 'vision':
        return (
          <svg width={s} height={s} viewBox="0 0 16 16" fill="none" className="text-accent-blue">
            ...
            <path
              d="M1 8C3 4 6 2 8 2s5 2 7 6c-2 4-5 6-7 6S3 12 1 8z"
              stroke="currentColor"
              strokeWidth="1.5"
              fill="none"
            />
      ...
      case 'json_mode':
        return (
          <svg width={s} height={s} viewBox="0 0 16 16" fill="none" className="text-accent-amber">
            <path
              d="M4 2C3 2 2 3 2 4v2c0 1-1 2-1 2s1 1 1 2v2c0 1 1 2 2 2M12 2c1 0 2 1 2 2v2c0 1 1 2 1 2s-1 1-1 2v2c0 1-1 2-2 2"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              fill="none"
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-7">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
        {tests.map((test, i) => (
          <motion.div key={test.type} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.06 }}>
            <Card
              size="small"
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {test.details && (
                    <p className="text-[10px] text-text-secondary/60 font-mono truncate">{test.details}</p>
                  )}
                </div>
              </div>
            </Card>
